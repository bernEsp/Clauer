...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<multi_xml>, ["~> 0.3.0"])
      s.add_runtime_dependency(%q<oa-core>, ["= 0.3.0.rc3"])
      ...
      s.add_dependency(%q<multi_xml>, ["~> 0.3.0"])
      s.add_dependency(%q<oa-core>, ["= 0.3.0.rc3"])
